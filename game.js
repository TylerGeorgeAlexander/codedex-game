...
function moveDown() { keys["ArrowDown"] = true; }

function stopLeft() { delete keys["ArrowLeft"]; }
function stopRight() { delete keys["ArrowRight"]; }
function stopUp() { delete keys["ArrowUp"]; }
function stopDown() { delete keys["ArrowDown"]; }

document.getElementById("left").addEventListener("touchstart", moveLeft, { passive: false });
document.getElementById("left").addEventListener("touchend", stopLeft, { passive: false });
document.getElementById("right").addEventListener("touchstart", moveRight, { passive: false });
document.getElementById("right").addEventListener("touchend", stopRight, { passive: false });
document.getElementById("up").addEventListener("touchstart", moveUp, { passive: false });
document.getElementById("up").addEventListener("touchend", stopUp, { passive: false });
document.getElementById("down").addEventListener("touchstart", moveDown, { passive: false });
document.getElementById("down").addEventListener("touchend", stopDown, { passive: false });
